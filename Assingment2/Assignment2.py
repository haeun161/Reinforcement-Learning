...
def plot_comparison(stats_q_learning, stats_sarsa, stats_expected_sarsa, stats_n_step_sarsa, smoothing_window=10):
    ...
    # Expected SARSA 보상
    rewards_smoothed_expected_sarsa = pd.Series(stats_n_step_sarsa.episode_rewards).rolling(smoothing_window, min_periods=smoothing_window).mean()
    plt.plot(rewards_smoothed_expected_sarsa, label="n_step_SARSA")
...
Q_n_step_sarsa, stats_n_step_sarsa = n_step_sarsa(env, num_episodes=500, n=3)

# 그래프 출력 함수 호출
plot_comparison(stats_q_learning, stats_sarsa, stats_expected_sarsa, stats_n_step_sarsa)