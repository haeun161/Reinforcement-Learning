...
# lmbda = 0.9  # Lambda value for eligibility traces
# num_episodes = 300

# # Initialize QEstimator
# estimator_n = QEstimator(step_size=step_size, trace = True)

# # Run the Sarsa(lambda) algorithm
# start_time = timeit.default_timer()
# run_stats_lambda = run(
#     'sarsa_lambda', 
...
step_size = 0.5  # Fraction of the way we want to move towards target
n = 2  # Level of bootstrapping (set to intermediate value)
num_episodes = 300
